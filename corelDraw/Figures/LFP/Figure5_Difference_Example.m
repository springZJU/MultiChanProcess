...
baseWin = [-200, 0];
plotWin = [-50, 300];
tempCSD = popRes(11).chCSD;  %20221216
tempMUA = popRes(11).chMUA;  %20221216
% CSD
...
FIGNAME = strcat(SAVEPATH, "\Figure1_RegIrreg");
