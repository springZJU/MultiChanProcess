...
baseWin = [-200, 0];
plotWin = [-50, 300];
tempCSD = popRes(2).chCSD;  %20221201-2, 20221209-6, 20221215-10, 20221222-15, 20221224-17, 20221225-18
tempMUA = popRes(2).chMUA;  
% CSD
...
FIGNAME = strcat(SAVEPATH, "\Figure3_Difference");
