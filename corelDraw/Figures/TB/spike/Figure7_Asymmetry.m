...
plotII.IIPI(idx).se = std(plotII.IIPI(idx).data)/sqrt(length(plotII.IIPI(idx).data));
[~, plotII.IIPI(idx).pVal] = ttest(plotII.IIPI(idx).data, 0);
...
plotII.IISI(idx).se = std(plotII.IISI(idx).data)/sqrt(length(plotII.IISI(idx).data));
[~, plotII.IISI(idx).pVal] = ttest(plotII.IISI(idx).data, 0);
end
