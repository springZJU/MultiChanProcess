...
BasicPATH = strcat(popResPath, "TB_Basic_4_4.06_Contol_Tone\");
% DDZ
DDZ_Data = load(strcat(BasicPATH, "DDZ_popRes"), "-mat", "popAll");
% CM
CM_Data = load(strcat(BasicPATH, "CM_popRes"), "-mat", "popAll");
basicData = popAll;
